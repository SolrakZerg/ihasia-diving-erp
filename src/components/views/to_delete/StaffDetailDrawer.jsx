import { X, Phone, Mail, MapPin, Calendar, Award, Activity, Heart, Globe, CreditCard, Hash, ShieldCheck, UserCheck, Banknote, Percent } from 'lucide-react';

export default function StaffDetailDrawer({ member, isOpen, onClose }) {
