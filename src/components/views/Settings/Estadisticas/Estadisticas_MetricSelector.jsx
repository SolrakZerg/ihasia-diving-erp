...
function ComparisonCollage({ active, size = 'large' }) {
  ...
  return (
    <div className={`relative w-20 h-14 md:w-40 md:h-28 grid grid-cols-2 grid-rows-[1fr,0.5fr] gap-1 md:gap-2 p-0.5 md:p-1 transition-all duration-700 ${active ? 'scale-110' : 'opacity-60 grayscale group-hover:grayscale-0 group-hover:opacity-80'}`}>
      <div className="flex items-center justify-center overflow-hidden">
      ...
      <div className="col-span-2 flex items-center justify-center overflow-hidden px-6 md:px-14 opacity-50">
        <img src={logos[2].src} alt={logos[2].alt} className="w-full h-full object-contain" />
      </div>
    </div>
  );
      ...
      {METRIC_CONFIGS.map(m => {
        ...
        return (
          <button
            ...
            className={`relative group flex flex-col items-center justify-between gap-3 md:gap-6 p-3 md:p-6 h-28 md:h-56 rounded-2xl md:rounded-[2.5rem] border transition-all duration-500 overflow-hidden ${
              isActive
          ...
          >
            ...
            <div className="flex-1 flex items-center justify-center w-full">
              {m.id === 'comparativa' ? (
                ...
                <img
                  ...
                  className={`w-16 h-12 md:w-40 md:h-28 object-contain transition-all duration-700 ${
                    isActive
                ...
                <Icon
                  ...
                  className={`w-8 h-8 md:w-20 md:h-20 transition-all duration-700 ${
                    isActive
            ...
            {/* Label */}
            <span className={`text-[10px] md:text-[13px] font-black uppercase tracking-[0.15em] md:tracking-[0.3em] transition-all duration-500 ${
