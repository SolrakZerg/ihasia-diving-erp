...
// -----------------------------------------------------------------
const DateCell = ({ item, handleItemUpdate, bLine, formatSmartDate, selectedMonth, selectedYear, setToast }) => {
  const dateInputRef = useRef(null);

  // Calcular si la fecha actual del item pertenece al mes seleccionado
