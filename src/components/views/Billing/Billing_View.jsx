...
export default function Billing_View({ isSidebarCollapsed }) {
        ...
        >
          {loadingInvoices ? (
            ...
            >
              ...
              <thead className="sticky top-0 z-30 bg-table-header/98 shadow-sm">
                <tr className="border-b border-white/5">
                  ...
                  <th className="px-1 py-2 text-center relative overflow-hidden" style={{ width: widths.actions }}>
                    ...
                    <button
                      ...
                      className="p-1 hover:bg-white/10 text-text-muted hover:text-white rounded transition-colors"
                    >
