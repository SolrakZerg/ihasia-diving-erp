...
export default function Billing_Header_Caja({
  ...
  return (
    <div className="flex-none w-fit flex flex-col border border-surface-edge rounded-xl bg-surface-soft shadow-md overflow-hidden min-w-[180px] shrink-0">
        ...
        >
          {billRows.map((b, index) => (
            <div key={b.label} className="flex items-center justify-between gap-2 group">
              ...
              />
              <div className="w-16 text-right text-text-muted font-mono text-[12px]">
        ...
        <div className="mt-2 pt-2 border-t border-surface-edge/50 space-y-1">
          <div className="flex flex-col gap-0.5">
            <div className="flex justify-between items-center">
              <span className="text-text-muted text-[12px] uppercase font-black">Hay:</span>
              <span className="text-white font-black text-[15px] font-mono tracking-tighter leading-tight">
                {actualCash.toLocaleString()} ฿
              </span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-text-muted text-[12px] uppercase font-black tracking-tighter">Debería:</span>
              <span className="text-white font-black text-[15px] font-mono tracking-tighter leading-tight">
      ...
      {/* Pie de caja con balance destacado (centrado, grande y ultra compacto) */}
      <div className="flex flex-col items-center pt-0 pb-1 px-2 bg-surface border-t border-surface-edge/30 shrink-0">
        ...
        <span className="text-[9px] uppercase text-text-muted font-black mt-0.5">
