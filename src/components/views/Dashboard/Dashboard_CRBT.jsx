export default function Dashboard_CRBT({ monthlyReport }) {
  ...
  return (
    <div className="bg-surface-soft border border-surface-edge rounded-2xl p-4 shadow-xl flex flex-col justify-center min-h-[240px] mx-auto md:mx-0 max-md:w-full md:max-w-[400px]">
      <h3 className="text-[14px] font-black text-text-header uppercase tracking-[0.2em] mb-0 text-center">CRBT</h3>
      ...
      <div className="flex-1 flex flex-col justify-center gap-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="flex flex-col gap-1.5">
            <span className="text-[12px] font-black text-text-header uppercase tracking-widest text-center">CR (x cobrar)</span>
            <div className="bg-cr rounded-xl p-3 text-center border border-white/10 shadow-lg">
          ...
          <div className="flex flex-col gap-1.5">
            <span className="text-[12px] font-black text-text-header uppercase tracking-widest text-center">BT (x cobrar)</span>
            <div className="bg-bt rounded-xl p-3 text-center border border-white/10 shadow-lg">
              <span className="text-[24px] font-black text-white font-mono tracking-tighter drop-shadow-md">
