...
export default function Dashboard_Table_Gastos({
  ...
  return (
    <div style={{ flex: '1.5 1 350px', maxWidth: '550px' }} className="bg-surface-soft border border-surface-edge rounded-3xl p-4 shadow-xl h-[480px] flex flex-col relative overflow-hidden">
      ...
      <h3 className="text-[14px] font-black text-gray-400 uppercase tracking-[0.2em] mb-4 text-center z-10">Gastos</h3>
        ...
        <table className="w-full text-left border-collapse">
          <thead className="sticky top-0 bg-surface-soft/95 backdrop-blur-md z-20">
            <tr className="border-b border-surface-edge/40">
              <th className="text-[10px] font-black text-gray-400 uppercase py-1 text-center w-20 tracking-widest">Cat.</th>
              <th className="text-[10px] font-black text-rose-400/80 uppercase py-1 text-center w-24 tracking-widest">Gastos</th>
              <th className="text-[10px] font-black text-emerald-500 uppercase py-1 text-center w-10 tracking-widest">Pag.</th>
              <th className="text-[10px] font-black text-rose-400/60 uppercase py-1 text-center w-28 tracking-widest">X Pagar</th>
