...
export default function Dashboard_Chart_CRBT({ incomeData }) {
  ...
  if (!mounted) {
    return (
      <div style={{ flex: '1 1 200px' }} className="bg-surface-soft border border-surface-edge rounded-2xl p-4 shadow-xl flex flex-col h-[480px] max-md:w-full md:max-w-[300px] items-center justify-center text-xs text-text-muted">
        Cargando gráficos...
      </div>
    );
  }
