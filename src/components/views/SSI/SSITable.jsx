        ...
        <table className="w-full text-left border-collapse">
          <thead className="sticky top-0 z-30">
            <tr className="bg-[#1a1c2d]/98 backdrop-blur-xl border-b border-surface-edge/50 h-[40px]">
              ...
              <th className="px-[10px] py-0 text-[10px] font-black text-slate-500 uppercase tracking-widest text-center align-middle w-24">Ajuste Manual</th>
              <th className="px-[10px] py-0 text-[10px] font-black text-amber-500 uppercase tracking-widest text-center align-middle w-24">Und. Reales</th>
              ...
              data.map(act => (
                <tr key={act.id} className="hover:bg-brand/5 border-b border-surface-edge/30 transition-colors group">
                  ...
                  <td className="px-[10px] py-2.5 text-center">
                    <span className="inline-flex items-center justify-center bg-surface-edge/30 min-w-[34px] h-9 rounded-lg text-[16px] font-black text-gray-400 font-mono">
                       {act.system_quantity}
                    </span>
                  </td>
                  <td className="px-[10px] py-2.5 text-center">
                    <input
                      ...
                      className={`w-16 bg-surface-edge/60 text-center h-9 rounded-lg text-[16px] font-black border border-gray-300/30 shadow-sm font-mono focus:border-amber-500 outline-none ${
                  ...
                  <td className="px-[10px] py-2.5 text-right">
                    <span className="text-[15px] font-bold text-gray-400 font-mono italic">{act.unit_cost.toLocaleString()}</span>
                  </td>
                  <td className="px-[10px] py-2.5 text-right">
                    <span className="text-[22px] font-black font-mono tracking-tighter text-amber-400">
