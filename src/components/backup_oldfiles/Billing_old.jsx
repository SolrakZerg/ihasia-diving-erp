...
// Thin header cell with resize handle ÔÇö NO minWidth on th, colgroup is the sole width authority
  ...
  useEffect(() => {
    if (!billing.loadingInvoices && scrollRef.current) {
      ...
      if (shouldScroll === 'true') {
        ...
        }, 300); // Peque├▒o delay para dejar que la tabla renderice
        return;
      }

      // 2. Si no, restaurar posici├│n guardada
