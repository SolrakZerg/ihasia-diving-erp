...
export default function Billing_GridRow({
  ...
  // ÔöÇÔöÇ Estado local ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  // ÔöÇÔöÇ Selecci├│n ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  // ÔöÇÔöÇ Handlers de factura ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    if (setConfirmConfig) {
      setConfirmConfig({
        ...
        message: items.length === 1
          ? 'Este es el ├║ltimo registro de la factura. Si lo borras, se eliminar├í la factura completa. ┬┐Deseas continuar?'
          : '┬┐Est├ís seguro de que deseas eliminar este registro?',
        type: 'danger',
        onConfirm: async () => {
          try {
  ...
  const handleItemUpdate = async (item, fieldOrUpdates, value) => {
    ...
    try {
      ...
      // Crear la descripci├│n hiper-detallada para el Toast
      const customerName = item.customers?.first_name || item.temporary_name || 'Sin nombre';
      let actionDesc = {
        undo: `Deshecho: Modificaci├│n en factura de ${customerName}`,
        redo: `Rehecho: Modificaci├│n en factura de ${customerName}`
      };
      ...
      if (updates.customer_id !== undefined) {
        ...
        if (field === 'unit_price_thb') {
          actionDesc = {
            undo: `Deshecho: Precio de factura de ${customerName} restaurado a ${oldVal || 0} Ó©┐ (era ${newVal || 0} Ó©┐)`,
            redo: `Rehecho: Precio de factura de ${customerName} cambiado a ${newVal || 0} Ó©┐ (era ${oldVal || 0} Ó©┐)`
          };
          ...
          actionDesc = {
            undo: `Deshecho: M├®todo de pago de ${customerName} restaurado a '${oldVal || 'Ninguno'}' (era '${newVal || 'Ninguno'}')`,
            redo: `Rehecho: M├®todo de pago de ${customerName} cambiado a '${newVal || 'Ninguno'}' (era '${oldVal || 'Ninguno'}')`
          };
        } else if (field === 'is_comm') {
          const oldComm = oldVal ? 'S├ì' : 'NO';
          const newComm = newVal ? 'S├ì' : 'NO';
          actionDesc = {
            undo: `Deshecho: Comisi├│n de ${customerName} restaurada a ${oldComm} (era ${newComm})`,
            redo: `Rehecho: Comisi├│n de ${customerName} cambiada a ${newComm} (era ${oldComm})`
          };
  ...
  // ÔöÇÔöÇ Utilidades ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  // ÔöÇÔöÇ C├ílculos de grupo ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  ...
  // ÔöÇÔöÇ Config de colores din├ímicos desde uiConfig ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  const cfg = uiConfig || {
  ...
  // ÔöÇÔöÇ MODO H├ìBRIDO (1 solo item, sin agrupaci├│n visual) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  if (isHybrid) {
  ...
  // ÔöÇÔöÇ MODO GRUPO (m├║ltiples items o _wasGroup) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
  return (
    <>
